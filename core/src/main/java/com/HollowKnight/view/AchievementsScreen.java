...
public class AchievementsScreen implements Screen {
    ...
    public void show() {
        ...
        addAchievementRow(contentTable, "ui/Achievements/achievement__0000_100_complete.png", "COMPLETION", Translator.getText("Completion"), AchievementManager.COMPLETION);
        addAchievementRow(contentTable, "ui/Achievements/achievement_fast_finish.png", "SPEEDRUN", Translator.getText("Speedrun"), AchievementManager.SPEEDRUN);
